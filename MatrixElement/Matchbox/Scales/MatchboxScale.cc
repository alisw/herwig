...
string MatchboxScale::doFunction(string in) {
  ...
  makeFile<< "THEPEG=/mt/home/dgrell/opt/ThePEG-release\n" ;
  makeFile<< "HERWIG=/tmp/Herwig-release\n" ;
  makeFile<< "INCLUDE=-I $(THEPEG)/include -I $(HERWIG)/include\n" ;
  makeFile<< "LIBPATH=-L/mt/home/dgrell/opt/ThePEG-release/lib/ThePEG\n" ;
  makeFile<< "SHARED_FLAG=-shared  \n";
  makeFile<< "all:                                             \n" ;
  makeFile<< "\tg++ $(SHARED_FLAG)  -g3  -fPIC -o "<<scalePath<<"Scale.so $(INCLUDE) $(LIBPATH) -lThePEG   Scale.cc\n" ;
  makeFile<< flush ;	  
